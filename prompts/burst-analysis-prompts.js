...
23. **burst_6_term** (排名第6的突现词)
    - 识别模式：突现强度第6高的词汇
    - 输出词汇名称

24. **burst_6_strength** (排名第6的突现强度)
    - 识别模式：排名第6的突现词的强度值
    - 输出纯数字

25. **burst_6_start_year** (排名第6的开始年份)
    - 识别模式：排名第6的突现词的开始年份
    - 输出纯数字年份

26. **burst_6_duration** (排名第6的持续年数)
    - 识别模式：排名第6的突现词的持续时间
    - 输出纯数字

27. **burst_7_term** (排名第7的突现词)
    - 识别模式：突现强度第7高的词汇
    - 输出词汇名称

28. **burst_7_strength** (排名第7的突现强度)
    - 识别模式：排名第7的突现词的强度值
    - 输出纯数字

29. **burst_7_start_year** (排名第7的开始年份)
    - 识别模式：排名第7的突现词的开始年份
    - 输出纯数字年份

30. **burst_7_duration** (排名第7的持续年数)
    - 识别模式：排名第7的突现词的持续时间
    - 输出纯数字

31. **burst_8_term** (排名第8的突现词)
    - 识别模式：突现强度第8高的词汇
    - 输出词汇名称

32. **burst_8_strength** (排名第8的突现强度)
    - 识别模式：排名第8的突现词的强度值
    - 输出纯数字

33. **burst_8_start_year** (排名第8的开始年份)
    - 识别模式：排名第8的突现词的开始年份
    - 输出纯数字年份

34. **burst_8_duration** (排名第8的持续年数)
    - 识别模式：排名第8的突现词的持续时间
    - 输出纯数字

35. **burst_9_term** (排名第9的突现词)
    - 识别模式：突现强度第9高的词汇
    - 输出词汇名称

36. **burst_9_strength** (排名第9的突现强度)
    - 识别模式：排名第9的突现词的强度值
    - 输出纯数字

37. **burst_9_start_year** (排名第9的开始年份)
    - 识别模式：排名第9的突现词的开始年份
    - 输出纯数字年份

38. **burst_9_duration** (排名第9的持续年数)
    - 识别模式：排名第9的突现词的持续时间
    - 输出纯数字

39. **burst_10_term** (排名第10的突现词)
    - 识别模式：突现强度第10高的词汇
    - 输出词汇名称

40. **burst_10_strength** (排名第10的突现强度)
    - 识别模式：排名第10的突现词的强度值
    - 输出纯数字

41. **burst_10_start_year** (排名第10的开始年份)
    - 识别模式：排名第10的突现词的开始年份
    - 输出纯数字年份

42. **burst_10_duration** (排名第10的持续年数)
    - 识别模式：排名第10的突现词的持续时间
    - 输出纯数字

**严格输出JSON格式：**
{
  "total_burst_terms": 10,
  "current_burst_terms": 5,
  ...
  "burst_5_duration": 6,
  "burst_6_term": "creativity",
  "burst_6_strength": 2.89,
  "burst_6_start_year": 2014,
  "burst_6_duration": 5,
  "burst_7_term": "problem solving",
  "burst_7_strength": 2.67,
  "burst_7_start_year": 2014,
  "burst_7_duration": 4,
  "burst_8_term": "critical thinking",
  "burst_8_strength": 2.45,
  "burst_8_start_year": 2015,
  "burst_8_duration": 3,
  "burst_9_term": "innovation",
  "burst_9_strength": 2.23,
  "burst_9_start_year": 2015,
  "burst_9_duration": 4,
  "burst_10_term": "collaboration",
  "burst_10_strength": 2.01,
  "burst_10_start_year": 2016,
  "burst_10_duration": 3
}
